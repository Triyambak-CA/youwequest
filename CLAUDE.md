...
Two recurring automated workflows. Full instructions live in `claude-docs/` and are
loaded automatically based on context:

### Monthly macro report
**Trigger:** `./scripts/run_macro.sh` · or say "run the macro report"
**Instructions:** @claude-docs/macro.md

### Weekly regulatory update
**Trigger:** `./scripts/run_weekly.sh` · or say "run the weekly update" / "Friday digest"
**Instructions:** @claude-docs/weekly.md
