...
This section mirrors the weekly update workflow. Everything runs in one step from `run_macro.sh`.

### Trigger
When `run_macro.sh` is executed, or when Triyambak says any of:
